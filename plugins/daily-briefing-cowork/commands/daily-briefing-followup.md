---
description: Interactive Q&A about today's already-produced briefing. Reads today's state, walks through actionable items, takes follow-up actions (send drafted replies, promote to tasks, mark done) based on James's answers. Invoke manually after reading the morning briefing.
